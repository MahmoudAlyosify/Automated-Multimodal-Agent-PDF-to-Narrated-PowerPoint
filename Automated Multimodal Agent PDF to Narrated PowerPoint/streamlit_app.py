...
A user-friendly web interface to convert PDFs to PowerPoint presentations.
"""
...
with st.sidebar:
    ...
    language = st.text_input(
        "Language Code",
        "en",
        help="Enter language code (e.g., en, es, fr)"
    )
    ...
    if api_key:
        ...
        st.info("To enable AI-powered design, set MISTRAL_API_KEY in .env")
    ...
    st.info(
        """
        **PDF-to-Narrated-PowerPoint System**
        
        Automatically convert PDFs into professional PowerPoint presentations using AI.
        
        - 📄 Document Understanding Agent
        - 🧠 Mistral AI Brain (optional)
            ...
            if st.button("⚡ Generate PowerPoint", use_container_width=True, type="primary"):
                ...
                with st.spinner("🎨 Creating PowerPoint presentation..."):
                    try:
                        ...
                        if st.session_state.dua_result:
